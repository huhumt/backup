...
def parse_string(full_str):
    ...
    soup = BeautifulSoup(full_str.encode("gb18030"), "lxml")
    print(soup.prettify().encode("gb18030"))
    title = soup.title.string
    body_text_list = soup.p
    href_dict = {}
    for href in soup.find_all('a'):
        href_dict[soup.get_text()] = href.get('href')
...
if __name__ == "__main__":
    ...
    full_str=("<head>\n"
              ...
              "<body>\n"
              "dada")
    title, body_text_list, href_dict = parse_string(full_str)
    print(title)
    ...
    title, body_text_list, href_dict = parse_string(baidu_index)
    print(title.encode("gb18030"))
    print(body_text_list.encode("gb18030"))
    print(href_dict)
